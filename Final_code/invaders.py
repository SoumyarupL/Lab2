...
ALIEN1A_W = 20    # width and height of the sprite in pixels
ALIEN1A_H = 10
ALIEN1A = bytearray([0b0000001,0b11111110,0b00000000,
                     0b0000011,0b11111111,0b00000000,
                     0b0000111,0b11111111,0b10000000,
                     0b0001111,0b11111111,0b11000000,
                     0b0011111,0b11111111,0b11100000,
                     0b1111100,0b01111000,0b11111000,
                     0b1111111,0b11111111,0b11111000,
                     0b0000011,0b10000111,0b00000000,
                     0b0000100,0b01111000,0b10000000,
                     0b1111011,0b00000110,0b11110000])

ALIEN1B_W = 20
ALIEN1B_H = 10
ALIEN1B = bytearray([0b0000001,0b11111110,0b00000000,
                     0b0000011,0b11111111,0b00000000,
                     0b0000111,0b11111111,0b10000000,
                     0b0001111,0b11111111,0b11000000,
                     0b0011111,0b11111111,0b11100000,
                     0b1111100,0b01111000,0b11111000,
                     0b1111111,0b11111111,0b11111000,
                     0b0000110,0b01111001,0b10000000,
                     0b1100000,0b00000000,0b00110000,
                     0b0000111,0b00000011,0b10000000])


ALIEN2A_W = 24
ALIEN2A_H = 9
ALIEN2A = bytearray([0b11000000,0b00000000,0b00000011,
                     0b11000000,0b00000000,0b00000011,
                     0b00110000,0b00000000,0b00001100,
                     0b00001111,0b11111111,0b11110000,
                     0b00011100,0b01111110,0b00111000,
                     0b11111111,0b11111111,0b11111111,
                     0b11110000,0b11111111,0b00001111,
                     0b11100011,0b10000001,0b11000111,
                     0b00000001,0b11100111,0b10000000])

ALIEN2B_W = 24
ALIEN2B_H = 9
ALIEN2B = bytearray([0b11000000,0b00000000,0b00000011,
                     0b11000000,0b00000000,0b00000011,
                     0b00110000,0b00000000,0b00001100,
                     0b11101111,0b11111111,0b11110111,
                     0b11011100,0b01111110,0b00111011,
                     0b11111111,0b11111111,0b11111111,
...
ALIEN3A_W = 20
ALIEN3A_H = 12
ALIEN3A = bytearray([0b00000011,0b11111100,0b00000000,
                     0b00001111,0b11111111,0b00000000,
                     0b00111111,0b11111111,0b11000000,
                     0b11111111,0b11111111,0b11110000,
                     0b11100011,0b11111100,0b01110000,
                     0b11111111,0b11111111,0b11110000,
                     0b00111111,0b11111111,0b11000000,
                     0b00001111,0b11111111,0b00000000,
                     0b00000111,0b00001110,0b00000000,
                     0b00011000,0b11110001,0b10000000,
                     0b00000111,0b00001110,0b00000000,
                     0b00000000,0b11110000,0b00000000])

ALIEN3B_W = 20
ALIEN3B_H = 11
ALIEN3B = bytearray([0b00000011,0b11111100,0b00000000,
                     0b00001111,0b11111111,0b00000000,
                     0b00111111,0b11111111,0b11000000,
                     0b11111111,0b11111111,0b11110000,
                     0b11100011,0b11111100,0b01110000,
...
PLAYER_W = 20
PLAYER_H = 8
PLAYER = bytearray([0b00000000,0b00100000,0b000000000,
                    0b00000000,0b01110000,0b000000000,
                    0b00000000,0b11111000,0b000000000,
                    0b00000111,0b11111111,0b000000000,
                    0b11111111,0b11111111,0b111110000,
                    0b11111111,0b10001111,0b111110000,
                    0b00011111,0b10001111,0b110000000,
                    0b11111111,0b10001111,0b111110000])

LASER_W = 1
LASER_H = 8
LASER = bytearray([0b00000000,0b00100000,
...
ALIENS_INIT_Y = 8
ALIENS_VX = 5.0    # aliens speed along X and Y in pixels per loop
ALIENS_VY = 5.0
...
class Laser:
    ...
    def draw(self, game):
        if self.active:
            game.rect(int(self.x), int(self.y), self.width, self.height, 2)
...
while True:
    ...
    if game.button_up() or game.button_down():
    ...
    # print the score
    game.top_right_corner_text("Score:" + str(score))
